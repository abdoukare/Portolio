...
4. Get your credentials:
   - **Service ID** (from Email Services page) // service_l6zf27i
   - **Template ID** (from Email Templates page) // template_apnjv2z
   - **Public Key** (from Account page) // ldbTZp8KoNUT0JyFW
