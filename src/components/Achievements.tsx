...
const milestones = [
  ...
  },
  {
    ...
    subtitle: "Full Stack ",
    description: "Building production-ready applications for clients",
    icon: "💻",
    color: "#60a5fa",
  }, 
    {
...
const expertise = [
  { name: "Back-end Development", level: 92 },
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="md:hidden flex flex-col h-full">
            ...
            <div className="ach-header text-center mb-4">
              <span className="text-[10px] text-blue-400 uppercase tracking-widest">Track Record</span>
            ...
            >
              ...
              <p className="text-sm text-blue-400">{milestones[activeTimeline].subtitle}</p>
            ...
            <div className="space-y-2 lg:space-y-3 xl:space-y-6 2xl:space-y-10">
              ...
              <div className="ach-header">
                <div className="flex items-center gap-2 mb-1 lg:mb-1 xl:mb-2">
                  <div className="h-px w-6 lg:w-8 bg-gradient-to-r from-blue-500 to-transparent" />
                  <span className="text-[10px] lg:text-xs text-blue-400 uppercase tracking-widest leading-normal">Track Record</span>
                </div>
            ...
            <div className="relative">
                ...
                {milestones.map((milestone, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-[9px] md:text-[9px] lg:text-[10px] xl:text-xs text-blue-400">{milestone.subtitle}</p>
              ...
              <div className="absolute -right-4 top-1/2 -translate-y-1/2 hidden lg:flex flex-col gap-2">
                {milestones.map((_, i) => (
                  <div
                    key={i}
                    className={`w-1.5 h-8 rounded-full transition-all duration-300 ${i <= activeTimeline ? "bg-blue-500" : "bg-zinc-800"
                      }`}
                  />
                ))}
              </div>
      ...
      <div className="absolute bottom-4 lg:bottom-8 left-1/2 -translate-x-1/2 hidden md:flex items-center gap-4 text-zinc-600">
        <div className="flex gap-1.5">
          {milestones.map((_, i) => (
            <div
              key={i}
              className={`w-8 h-1 rounded-full transition-all duration-300 ${i <= activeTimeline ? "bg-blue-500" : "bg-zinc-800"
                }`}
            />
          ))}
        </div>
