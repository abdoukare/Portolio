...
const contactInfo = [
  {
    ...
    label: "Email",
    value: "abdelkhalekkadjoudj@gmail.com",
    href: "mailto:abdelkhalekkadjoudj@gmail.com",
    color: "#3b82f6",
  },
  {
    icon: (
  ...
  },
  {
    ...
    label: "GitHub",
    value: "github.com/abdoukare",
    href: "https://github.com/abdoukare",
    color: "#ffffff",
  },
  {
    icon: (
...
export default function Contact() {
  ...
  // EmailJS credentials
  const EMAILJS_SERVICE_ID = "service_l6zf27i";
  const EMAILJS_TEMPLATE_ID = "template_apnjv2z";
  const EMAILJS_PUBLIC_KEY = "ldbTZp8KoNUT0JyFW";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        {/* Gradient orbs */}
        <div className="float-element absolute top-20 left-1/4 w-96 h-96 bg-blue-600/10 rounded-full blur-[120px]" />
        <div className="float-element absolute bottom-20 right-1/4 w-80 h-80 bg-sky-600/10 rounded-full blur-[100px]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pt-8 sm:pt-16">
          ...
          <div className="contact-left space-y-10">
            ...
            <div>
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <div className="h-px w-8 sm:w-12 bg-gradient-to-r from-blue-500 to-transparent" />
                <span className="text-xs sm:text-sm text-blue-400 uppercase tracking-widest">Get In Touch</span>
              </div>
            ...
            <div className="relative p-5 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl bg-zinc-900/50 border border-zinc-800/50 backdrop-blur-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className={`relative rounded-xl transition-all duration-300 ${
                    focusedField === "subject" ? "ring-2 ring-blue-500/50" : ""
                  }`}>
                    <input
                      type="text"
                      name="subject"
                ...
                <div className="space-y-2">
                  ...
                  <div className={`relative rounded-xl transition-all duration-300 ${
                    focusedField === "message" ? "ring-2 ring-blue-500/50" : ""
                  }`}>
                    <textarea
                      name="message"
                ...
                <button
                  ...
                  className="group relative w-full py-4 rounded-xl bg-gradient-to-r from-blue-600 to-sky-600 text-white font-semibold overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {/* Button shine effect */}
              ...
              <div className="absolute -top-px -right-px w-20 h-20 overflow-hidden rounded-tr-3xl">
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-blue-500/20 to-transparent" />
              </div>
              <div className="absolute -bottom-px -left-px w-20 h-20 overflow-hidden rounded-bl-3xl">
                <div className="absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr from-sky-500/20 to-transparent" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 sm:mt-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            <a 
              href="https://www.linkedin.com/in/abdou-kadj-6022b9228/"
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3 rounded-full bg-zinc-800/50 border border-zinc-700/50 text-zinc-400 hover:text-white hover:border-zinc-600 transition-all duration-300 flex items-center gap-2"
            >
