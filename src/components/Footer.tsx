...
export default function Footer() {
  return (
    <footer className="relative bg-[#0a0a0f] border-t border-blue-500/10">
      {/* Gradient Line */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
              ...
              {socialLinks.map((social) => (
                <a
                  ...
                  rel="noopener noreferrer"
                    className="p-1.5 sm:p-2 rounded-lg bg-blue-500/10 text-gray-400 hover:text-blue-400 hover:bg-blue-500/20 transition-all duration-300"
        ...
        {/* Bottom Bar */}
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-blue-500/10 flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
