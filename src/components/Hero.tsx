...
const roles = ["Software Engineer", "DevOps/Cloud Practitioner"];
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen w-full overflow-hidden bg-[#08080a]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-175 h-175 bg-blue-600/15 rounded-full blur-[150px]" />
        <div className="absolute bottom-[-20%] right-[-10%] w-150 h-150 bg-indigo-600/10 rounded-full blur-[130px]" />
        <div className="absolute top-[30%] right-[15%] w-100 h-100 bg-sky-600/8 rounded-full blur-[100px]" />
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-12 items-center">
            ...
            <div className="hero-content space-y-8">
              ...
              <div className="space-y-3">
                <h1 className="text-4xl xs:text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight leading-[0.9]">
                  <span className="block mt-2">
                    <span className="text-white">Abdou</span>
                    <span className="text-zinc-600"> Kadjoudj</span>
                  </span>
                </h1>
                <div className="hero-line-accent h-1 w-20 bg-gradient-to-r from-blue-500 to-sky-500 rounded-full origin-left mt-6" />
              </div>

              {/* Role - Enhanced Typewriter */}
              <div className="flex items-center gap-2 sm:gap-3 text-lg sm:text-xl lg:text-2xl h-8 sm:h-10">
                <span className="text-zinc-600">&lt;</span>
                <span className="text-blue-400 font-mono">{displayText}</span>
                <span className="relative w-[3px] h-7 overflow-hidden">
                  <span className="absolute inset-0 bg-gradient-to-b from-blue-400 to-sky-400 animate-pulse" />
                </span>
                <span className="text-zinc-600">/&gt;</span>
              </div>
              ...
              <p className="text-sm sm:text-base lg:text-lg text-zinc-500 max-w-xl leading-relaxed">
                Specialized in building  <span className="text-zinc-300">high-performance Backend Web applications</span> and 
                <span className="text-zinc-300"></span> transform ideas into impactful digital experiences.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-x-4 sm:gap-x-8 gap-y-3 sm:gap-y-4 pt-4">
                <a href="#projects" className="group relative text-white font-medium text-base sm:text-lg">
                  ...
                  <span className="absolute bottom-0 left-0 w-full h-[2px] bg-gradient-to-r from-blue-500 to-sky-500 origin-left scale-x-100 group-hover:scale-x-0 transition-transform duration-300" />
                ...
                <a
                  href="/Kadjoudj_Abdelkhalek_CV.pdf"
                  download
            ...
            <div className="hero-visual relative flex items-center justify-center lg:justify-center mt-10 sm:mt-14 lg:mt-0 order-first lg:order-none">
              <div className="hero-float relative w-[280px] h-[280px] xs:w-[340px] xs:h-[340px] sm:w-[520px] sm:h-[520px] lg:w-[760px] lg:h-[760px] xl:w-[900px] xl:h-[900px] lg:-translate-x-20 xl:-translate-x-28 max-w-full">
                ...
                {/* Pulsing glow behind */}
                <div className="pulse-glow absolute inset-[-20%] rounded-full bg-gradient-to-br from-blue-600/20 via-transparent to-sky-600/20 blur-3xl" />

                {/* Outer orbit ring */}
                <div className="orbit-ring absolute inset-0">
                  {/* Orbit path */}
                  <div className="absolute inset-0 rounded-full border border-zinc-800/50" />
                  <div className="absolute inset-0 rounded-full border border-dashed border-blue-500/20 scale-[1.15] lg:scale-[1.28] xl:scale-[1.32]" />
                  
                  {/* Orbiting items */}
                  <div className="orbit-item absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <div className="orbit-item-inner px-2.5 py-1.5 sm:px-4 sm:py-2 bg-zinc-900/90 backdrop-blur-sm border border-zinc-700/50 rounded-full shadow-lg shadow-blue-500/10">
                  ...
                  <div className="orbit-item absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2">
                    <div className="orbit-item-inner px-2.5 py-1.5 sm:px-4 sm:py-2 bg-zinc-900/90 backdrop-blur-sm border border-zinc-700/50 rounded-full shadow-lg shadow-sky-500/10">
                      <span className="text-[11px] sm:text-sm font-medium text-zinc-300">System Design</span>
                    </div>
                  </div>
                  ...
                  <div className="orbit-item absolute right-0 top-1/2 translate-x-1/2 -translate-y-1/2">
                    <div className="orbit-item-inner px-2.5 py-1.5 sm:px-4 sm:py-2 bg-zinc-900/90 backdrop-blur-sm border border-zinc-700/50 rounded-full shadow-lg shadow-sky-500/10">
                      <span className="text-[11px] sm:text-sm font-medium text-zinc-300"></span>
                    </div>
                  </div>
                  ...
                  <div className="orbit-item absolute bottom-[15%] left-[15%]">
                    <div className="orbit-item-inner px-2 py-1 sm:px-3 sm:py-1.5 bg-zinc-900/90 backdrop-blur-sm border border-zinc-700/50 rounded-full">
                      <span className="text-[10px] sm:text-xs font-medium text-zinc-400">Node.js</span>
                    </div>
                  </div>
                ...
                <div className="absolute inset-[12%] lg:inset-[20%] xl:inset-[22%] rounded-full bg-gradient-to-br from-zinc-800/80 to-zinc-900/80 border border-zinc-700/50 shadow-2xl shadow-black/50 overflow-hidden">
                  {/* Gradient overlay */}
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-transparent to-sky-500/10" />
                  
                  {/* Inner border glow */}
                  <div className="absolute inset-[2px] rounded-full border border-blue-500/20" />
                ...
                {/* Accent dots */}
                <div className="absolute top-[10%] left-[10%] w-2 h-2 rounded-full bg-blue-500/60 animate-pulse" />
                <div className="absolute bottom-[10%] right-[10%] w-1.5 h-1.5 rounded-full bg-sky-500/60 animate-pulse" style={{ animationDelay: "1s" }} />
                <div className="absolute top-[50%] right-[5%] w-1 h-1 rounded-full bg-blue-400/40 animate-pulse" style={{ animationDelay: "0.5s" }} />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
        <a href="#about" className="flex flex-col items-center gap-3 text-zinc-600 hover:text-zinc-400 transition-colors group">
          ...
          <div className="w-px h-10 bg-gradient-to-b from-zinc-500 to-transparent group-hover:from-blue-500 transition-colors" />
        </a>
      </div>
