...
const projects: Project[] = [
  {
    id: 1,
    title: "Weliox",
    tagline: "financial Managment SaaS — Algeria",
    description:
      "The all-in-one platform to create, manage, and track your invoices, quotes, and clients. Optimize your accounting workflow with powerful and intuitive tools.",
    highlights: [
      "Multi-tenant vendor onboarding & subscription billing",
      "Real-time inventory & business management dashboards",
      "Dockerized CI/CD pipeline — zero-downtime deploys",
    ],
    images: {
      laptop: "/images/projects/weliox/weliox1.png",
      phone: "/images/projects/weliox/weliox2.png",
      desktop: "/images/projects/weliox/weliox1.png",
    },
    tags: ["Node.js", "Next.js", "TypeScript", "PostgreSQL", "Redis", "Docker", "CI/CD", "Tailwind"],
    demoUrl: "https://weliox.pro/",
    githubUrl: "",
    year: "2025",
    color: "#7700ff",
  },
  {
    id: 2,
    title: "Private School Manager",
    tagline: "School Management platform",
    description:
      "A full-stack school management system for students, teachers, courses, lessons, finances, reports, print requests, and role-based administration. The interface is Arabic-first and supports RTL layouts",    highlights: [
      "Admins manage all content without touching code",
      "SSR-first Next.js for Core Web Vitals & SEO rankings",
      "PostgreSQL-backed project & team management",
    ],
    images: {
      laptop: "/images/projects/school/school1.png",
      phone: "/images/projects/school/school3.png",
      desktop: "/images/projects/school/school2.png",
    },
    tags: ["Python", "FastApi", "PostgreSQL", "REST API", "Tailwind", "Next.js"],
    demoUrl: "https://shcool-management-system.vercel.app/",
    year: "2026",
    color: "#3139d6",
  },
];
