...
function MarqueeBadge({ item }: { item: typeof marqueeRow1[0] }) {
  return (
    <span
      className="inline-flex items-center gap-6 px-6 py-3 rounded-xl text-xs font-bold tracking-widest uppercase whitespace-nowrap border border-white/10 select-none"
      ...
      <div className="relative z-10 w-full flex flex-col items-center gap-10 px-4 sm:px-6 md:px-8">
        ...
        <div className="section-header text-center mb-12 sm:mb-16">
          <h3 className="mt-2 sm:mt-3 text-3xl sm:text-4xl lg:text-5xl font-bold text-white">
            My Tech Stack <span className="bg-gradient-to-r from-blue-400 to-blue-400 bg-clip-text text-transparent"></span>
          </h3>
        </div>
        </div>
